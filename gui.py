import pygame
import time
from Solver_Generator import solve, is_valid, generate_board, generate_puzzle
...
generate_puzzle(sudoku_board,'hard')    #Choose from easy, medium, hard, hardcore
...
def main():
    ...
    # Title and Icon
    pygame.display.set_caption('Diagonal Sudoku')
